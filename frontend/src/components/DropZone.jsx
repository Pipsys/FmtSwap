/**
 * Drag-and-drop + click file upload zone for PDF files.
...
export default function DropZone({ onConversionStarted }) {
  ...
  const handleFile = useCallback(async (file) => {
    ...
    if (file.size > 50 * 1024 * 1024) {
      setError('Файл превышает ограничение в 50 МБ')
      return
    }
    ...
    setProgress(0)
    try {
      const res = await convertApi.upload(file, setProgress)
  ...
  return (
    ...
    >
      ...
      <p className={styles.hint}>PDF · макс. 50 МБ</p>
